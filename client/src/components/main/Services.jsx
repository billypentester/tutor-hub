        ...
        <div class="container overflow-hidden">
            <div class="row gy-5 gy-md-6 gx-xl-6">
                ...
                <div class="text-center">
                    ...
                    <h5 class="m-2">Tutor Searching</h5>
                    <p class="m-0 text-dark">Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, vel placerat magna mauris mollis maximus est.</p>
                </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="text-center">
                        ...
                        <h5 class="m-2">Relaible Tutor</h5>
                        <p class="m-0 text-dark">Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, vel placerat magna mauris mollis maximus est.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="text-center">
                        ...
                        <h5 class="m-2">Digital Classroom</h5>
                        <p class="m-0 text-dark">Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, vel placerat magna mauris mollis maximus est.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="text-center">
                        ...
                        <h5 class="m-2">Report Generator</h5>
                        <p class="m-0 text-dark">Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, vel placerat magna mauris mollis maximus est.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="text-center">
                        ...
                        <h5 class="m-2">Appointment Scedulor</h5>
                        <p class="m-0 text-dark">Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, vel placerat magna mauris mollis maximus est.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="text-center">
                        ...
                        <h5 class="m-2">Feadback and Reviews</h5>
                        <p class="m-0 text-dark">Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, vel placerat magna mauris mollis maximus est.</p>
                    </div>
                </div>
            </div>
